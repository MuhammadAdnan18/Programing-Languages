...
if ('F:\uni\IQRA\courses\DBMS LAB\New folder\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('F:\uni\IQRA\courses\DBMS LAB\New folder\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
