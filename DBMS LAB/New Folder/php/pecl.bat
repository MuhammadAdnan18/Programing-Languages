...
FOR %%x IN ("F:\uni\IQRA\courses\DBMS LAB\New folder\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=F:\uni\IQRA\courses\DBMS LAB\New folder\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=F:\uni\IQRA\courses\DBMS LAB\New folder\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=F:\uni\IQRA\courses\DBMS LAB\New folder\php\php.exe"
GOTO :INSTALLED
